<template>
    <div class="w-full max-w-sm overflow-hidden rounded-lg shadow-lg bg-gray-800">
        ...
        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Not Found</h1>
            <p class="py-2 text-gray-400">Développeur Front End en apprentissage. <br />
                Je souhaite en faire mon métier, passionner par le développement web, je serais toujours ravi de pouvoir
                apprendre de nouvelle choses.</p>
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">Etudiant</h1>
            </div>
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">Bretagne</h1>
            </div>
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">mon.email@gmail.com</h1>
            </div>
        </div>
    </div>
</template>