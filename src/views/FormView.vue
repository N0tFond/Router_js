<template>
    <div class="flex justify-center align-middle p-20">
        <div style="animation: slideInFromLeft 1s ease-out"
            ...
            <h2 style="animation: appear 2s ease-out" class="text-center text-4xl font-extrabold text-white">Welcome
            </h2>
            <p style="animation: appear 3s ease-out" class="text-center text-gray-200">Sign in to your account</p>
